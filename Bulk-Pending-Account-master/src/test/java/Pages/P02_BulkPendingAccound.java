...
public class P02_BulkPendingAccound {
    ...
    public WebElement phoneNum(){return driver.findElement(By.xpath("//*[@id=\"data-table\"]/tbody/tr[1]/td[4]"));}
    public WebElement customerAlreadyUsed(){return driver.findElement(By.xpath("//*[@id=\"medicinesfull\"]/tbody/tr[1]/td[2]"));}
    ...
    public String customerAlreadyUsed ="* The phone number is already in use by customer abanoub nasser Ibrahim phone:01226364389";
}
