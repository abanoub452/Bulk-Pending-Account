...
public class D01_UploadValidSheets {
   ...
   @And("open import page and upload EDC sheet excel")
    public void ImportSheet(){
        bulkImport.importBtn().sendKeys("C:\\Users\\classic\\IdeaProjects\\Bulk-Pending-Account-master\\Files_Test\\EBC.xlsx");
   }
   ...
   public void importInvalidDataSheet(){
       bulkImport.importBtn().sendKeys("C:\\Users\\classic\\IdeaProjects\\Bulk-Pending-Account-master\\Files_Test\\InvalidDataSheet.xlsx");
   }
}
